import { BlogDetail, BlogPost } from "../types/blogType"
import { discussionDetailGql, discussionGql } from "./gql"

const API_URL = 'https://api.github.com/graphql'
const GH_ACCESS_TOKEN = process.env.GH_ACCESS_TOKEN
const DISCUSSTION_CATEGORY_ID = process.env.DISCUSSTION_CATEGORY_ID
export async function getBlogs():Promise<BlogPost[]> {
    const response = await fetch(API_URL,{
        ...
        body:JSON.stringify({query:discussionGql(DISCUSSTION_CATEGORY_ID)})
    })
